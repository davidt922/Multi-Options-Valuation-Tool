...
beforeMeanOfMeans = 0;
    while true
        [path, stepDatetimeArray, interestRateArray] = generatePathUsingGBM(subyacentValue, interestRate, volatility, stepSize, valuationDate, maturity, 3); % right 6000
        ...
        if not(numOfMeans == 1)
            ...
            if (abs(meanOfMeans - beforeMeanOfMeans) < 0.0000001)
               break; 
            end
